...
{
    public partial class cityjobshow : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            City_Name = Request.QueryString["jobCity_Name"].ToString();
        ...
        {
            objTable.Clear();
            objCommand = new SqlCommand("SP_CityJobInfo", objConnection);
            objCommand.Parameters.AddWithValue("@City_Name", City_Name);
