...
{
    public partial class fulltimejob : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Nature_Name = Request.QueryString["jobNature_Name"].ToString();
        ...
        {
            objTable.Clear();
            objCommand = new SqlCommand("SP_NatureJobInfo", objConnection);
            objCommand.Parameters.AddWithValue("@Nature_Name", Nature_Name);
